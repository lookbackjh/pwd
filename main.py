...
def get_args():
    ...
    parser.add_argument('--same_ratio',type=int, default=100,help='Difference ratio for each group') ## only can choose 10, 50 , 100
    ...
    parser.add_argument('--task',type=int,default=1,help='0 for checking sensitivity for the sparsity ratio and 1 for checking sensitivyt for various n, k') 
